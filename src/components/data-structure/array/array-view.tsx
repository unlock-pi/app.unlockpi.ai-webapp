...
/**
 * The array component: pure rendering, no notion of insert/delete/sort. It
 * takes a flat set of props describing one moment (which cells are active,
 * settled, found, where the caret is) and draws it — where those props come
 * FROM (a live voice agent, a pre-authored lesson, a static demo page) is
 * none of its business. See array-frame.ts for the shared `ArrayFrame`
 * snapshot shape a producer builds these props from.
 */

import { AnimatePresence, motion } from "motion/react";
import { useCallback, useId, useLayoutEffect, useRef, useState } from "react";

import { truncateValue } from "@/components/data-structure/array/array-frame";
    ...
    >
      <div className="relative flex items-center gap-4">
        ...
        <div className="relative" ref={containerRef}>
          ...
          {/*
            Discrete plates with a gap, matching StackView — same border,
...
const CELL_STATE_CLASS = {
  found:
    "border-emerald-300 bg-emerald-500 text-white ring-2 ring-emerald-400/50",
